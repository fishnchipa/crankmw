...
export default function Footer() {
  ...
  return (
    <div 
      className="w-full sm:h-[500px] flex flex-col sm:flex-row justify-between bg-[#494949] text-white px-5 sm:px-[80px] py-10 mt-[50px] gap-y-10"
    >
      ...
      <div className="w-[250px] flex flex-col gap-y-5">
        ...
        />
        <button className="bg-[#F5A329] px-7 py-4 text-black hover:text-white">Subscribe</button>
      </div>
    </div>
  )
}
